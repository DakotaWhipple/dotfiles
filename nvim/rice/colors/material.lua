...
-- rice-MaterialDark — GENERATED by theme-palette. Edit themes/MaterialDark/seed.sh instead.
-- IntelliJ-New-UI-flavored mapping over the MaterialDark palette.
vim.cmd.highlight("clear")
vim.g.colors_name = "material"
vim.o.termguicolors = true

local c = {
  bg = "#0d1016", bg_dark = "#080a0e", bg_hl = "#424242",
  fg = "#e5e5e5", muted = "#d9d9d9", accent = "#16afca", alt = "#54a4f3",
  red = "#b7141f", green = "#457b24", yellow = "#f6981e",
  blue = "#134eb2", magenta = "#560088", cyan = "#0e717c",
  kw = "#e83b3f", fn = "#54a4f3", str = "#7aba3a",
  num = "#26bbd1", typ = "#ffea2e", const = "#aa4dbc",
  prop = "#d9d9d9", comment = "#424242", op = "#efefef",
  special = "#54a4f3",
  border_a = "#16afca", border_i = "#212121",
  black = "#212121", bblack = "#424242",
}
...
hl("DiffAdd", { bg = "#172318" })
hl("DiffChange", { bg = "#0e1b32" })
hl("DiffDelete", { bg = "#2b1017" })
hl("DiffText", { bg = "#0e2347" })
hl("Added", { fg = c.green })
hl("Changed", { fg = c.fn })
hl("Removed", { fg = c.red })
